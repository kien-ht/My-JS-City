  ...
  if (nowscene !== null) {
    ...
    if (nowscene >= 13 && nowscene < 22) {
      scenescreen.innerHTML =
        scenescreen.innerHTML + `<img src="./img/teacher.png" alt="" id="teacher">`;
    }
    if (nowscene >= 22 && nowscene < 25) {
      scenescreen.innerHTML =
        scenescreen.innerHTML + `<img src="./img/friend.png" alt="" id="friend">`;
    }
    if (nowscene == 26) {
      scenescreen.innerHTML =
        scenescreen.innerHTML + `<img src="./img/oldwomen.png" alt="" id="oldwomen">`;
    }
    if (nowscene >= 28 && nowscene < 31) {
      scenescreen.innerHTML =
        scenescreen.innerHTML + `<img src="./img/fruit.png" alt="" id="fruit">`;
    }
    if (nowscene >= 31 && nowscene < 36) {
      scenescreen.innerHTML =
        scenescreen.innerHTML + `<img src="./img/oldman.png" alt="" id="oldman">`;
    }
    if (nowscene >= 36 && nowscene < 38) {
      scenescreen.innerHTML =
        scenescreen.innerHTML + `<img src="./img/parkman.png" alt="" id="parkman">`;
    }
